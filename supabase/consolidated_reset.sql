-- =====================================
-- FORM SERVICE DATABASE SAFE RESET SCRIPT
-- =====================================
-- This script safely resets the database even if all tables have been deleted
-- Run this to completely reset and recreate your form service database

-- Step 1: Clean up any remaining objects safely
-- =====================================
...
-- =====================================
CREATE TYPE public.subscription_status AS ENUM ('free', 'pro', 'premium', 'canceled');
...
-- Step 4: Add foreign key constraints to auth.users (if it exists)
-- =====================================
DO $$
BEGIN
...
-- Grant specific permissions for anonymous users
