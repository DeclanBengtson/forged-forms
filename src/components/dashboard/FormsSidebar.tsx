...
export default function FormsSidebar({ 
  ...
  const handleFormSelect = (form: Form | null) => {
    onSelectForm(form);
    // Close mobile menu when form is selected
  ...
  return (
    <>
      {/* Transparent click-outside area for mobile */}
      {isMobileMenuOpen && (
        <div 
      ...
      {/* Sidebar */}
      <div className={`
        w-64 fixed left-0 top-[73px] bg-white border-r border-gray-200 h-[calc(100vh-73px)] pt-4 transition-transform duration-300 ease-in-out
        lg:translate-x-0 lg:z-10
        ${isMobileMenuOpen ? 'translate-x-0 z-30' : '-translate-x-full lg:translate-x-0 z-10'}
      `}>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  className="w-7 h-7 bg-black text-white rounded-sm hover:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-2 transition-all duration-200 flex items-center justify-center"
