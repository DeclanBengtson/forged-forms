...
export default function PricingPage() {
  ...
  const handlePlanSelect = async (plan: 'pro' | 'enterprise') => {
    if (!user) {
  ...
  const canUpgrade = (plan: string) => {
    ...
    if (plan === 'pro') return userSubscription.status === 'free';
    if (plan === 'enterprise') return ['free', 'pro'].includes(userSubscription.status);
    return false;
  };
            ...
            >
              ...
              <div className={`p-8 ${plan.popular ? 'pt-12' : ''}`}>
                ...
                <div className="text-center">
                  {isCurrentPlan(key) ? (
                    <div>
                      <div className="bg-green-100 text-green-800 py-3 px-6 rounded-lg font-medium mb-4">
                        Current Plan
                    ...
                    <div className="text-gray-600 py-3 px-6 rounded-lg border border-gray-300">
                      Always Free
                    </div>
                  ) : canUpgrade(key) ? (
                    <button
                      onClick={() => handlePlanSelect(key as 'pro' | 'enterprise')}
                    ...
                    <div className="text-gray-500 py-3 px-6 rounded-lg border border-gray-200">
                      Downgrade Available
                    </div>
                  )}
                </div>
